...
<body data-locale="ko">
	<div id="webView" data-canvas="true" data-show-memo="false"
		...
		<div data-obj-id="GMSqV" data-obj-type="element"
			data-text-editable="true" class=""
			style="position: absolute; top: 176px; left: 218px; width: 734px; height: 40px;">
			<input type="text" data-min-width="60" data-min-height="30"
				data-text-content="true" value="내용을 입력해주세요"
				style="color: rgb(94, 94, 94);">
		</div>
		<div data-obj-id="I1nRK" data-obj-type="element"
			data-text-editable="true" class=""
			style="position: absolute; top: 143px; left: 220px; width: 300px; height: 27px;">
			<div data-text-content="true"
				style="font-weight: bold; font-size: 18px" class="">제목</div>
		</div>
		<div data-obj-id="qpGGg" data-obj-type="element"
			data-text-editable="true" class=""
			style="position: absolute; top: 229px; left: 219.1px; width: 300px; height: 27px;">
			<div data-text-content="true"
				style="font-weight: bold; font-size: 18px" class="">내용</div>
		</div>
		<div data-obj-id="6y4Oa" data-obj-type="element"
			data-text-editable="true" class=""
			style="position: absolute; top: 268px; left: 218px; width: 733px; height: 293px;">
			<textarea data-text-content="true" data-min-width="100"
				data-min-height="60" style="color: rgb(94, 94, 94);">내용을 입력해주세요</textarea>
		</div>
		<div data-obj-id="cC6EE" data-obj-type="element"
			data-text-editable="true" class=""
			style="position: absolute; top: 574px; left: 851px; width: 100px; height: 40px;">
			<div data-text-content="true"
				...
				spellcheck="false" class="">작성 완료</div>
		</div>
		<div data-obj-id="prI6X" data-obj-type="element"
			data-text-editable="true" class=""
	...
	<div style="" class="ovenWebview_Nav">
		<a href="/view/msLIKPGTqwMxFjQLhURzl6SrDOJDgR2j/K8GLD"
			...
			href="/view/msLIKPGTqwMxFjQLhURzl6SrDOJDgR2j/Mx3h3" class="move_next"><span
		...
		<div style="display: none;" class="ovenWebview_MoreMenu">
			...
			<div style="display: none;" class="sub">
				<a href="/view/msLIKPGTqwMxFjQLhURzl6SrDOJDgR2j/JAmP5">1. 로그인 X
					...
					게시글 작성_홈</a><a href="javascript:;" class="current">8. 게시글 작성_글쓰기</a><a
					href="/view/msLIKPGTqwMxFjQLhURzl6SrDOJDgR2j/Mx3h3">9. 게시글
					작성_게시글</a>
			</div>
