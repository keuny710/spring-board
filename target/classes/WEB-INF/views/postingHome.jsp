...
<body data-locale="ko">
	<div id="webView" data-canvas="true" data-show-memo="false"
		...
		<div data-obj-id="8vIwH" data-obj-type="element"
			data-text-editable="true" class=""
			style="position: absolute; top: 143px; left: 224px; width: 235px; height: 36px;">
			<div data-text-content="true"
				style="font-weight: bold; font-size: 24px" class=""
				spellcheck="false">게시글 작성</div>
		</div>
		<div data-obj-id="kaPMq" data-obj-type="element"
			data-text-editable="true" class=""
			style="position: absolute; top: 202px; left: 226px; width: 300px; height: 27px;">
			<div data-text-content="true"
				style="font-weight: bold; font-size: 18px">그들의 이상은 아름답고 소담스러운</div>
		</div>
		<div data-obj-id="8RAsq" data-obj-type="element"
			data-text-editable="true" class=""
			style="position: absolute; top: 228px; left: 226px; width: 300px; height: 20px;">
			<div data-text-content="true" style="font-size: 16px;">Text -
				Double click to edit</div>
		</div>
		<div data-obj-id="DYRSU" data-obj-type="element"
			data-text-editable="true" class=""
			style="position: absolute; top: 289px; left: 226px; width: 300px; height: 27px;">
			<div data-text-content="true"
				style="font-weight: bold; font-size: 18px">그들의 이상은 아름답고 소담스러운</div>
		</div>
		<div data-obj-id="VT70N" data-obj-type="element"
			data-text-editable="true" class=""
			style="position: absolute; top: 315px; left: 226px; width: 300px; height: 20px;">
			<div data-text-content="true" style="font-size: 16px;">Text -
				Double click to edit</div>
		</div>
		<div data-obj-id="vIPfH" data-obj-type="element"
			data-text-editable="true" class=""
			style="position: absolute; top: 377px; left: 224px; width: 300px; height: 27px;">
			<div data-text-content="true"
				style="font-weight: bold; font-size: 18px">그들의 이상은 아름답고 소담스러운</div>
		</div>
		<div data-obj-id="WXEBG" data-obj-type="element"
			data-text-editable="true" class=""
			style="position: absolute; top: 403px; left: 224px; width: 300px; height: 20px;">
			<div data-text-content="true" style="font-size: 16px;">Text -
				Double click to edit</div>
		</div>
		<div data-obj-id="oE3y3" data-obj-type="element"
			data-text-editable="true" class=""
		...
		<div data-obj-id="6spHY" data-obj-type="element"
			data-text-editable="true" class=""
			style="position: absolute; top: 139px; left: 847px; width: 100px; height: 40px;">
			<div data-text-content="true"
				...
				spellcheck="false" class="">글쓰기</div>
		</div>
	</div>
	<div id="ovenWebview_Gesture" class="ovenWebview_Gesture">
		<div id="gesture_left"
			data-id="msLIKPGTqwMxFjQLhURzl6SrDOJDgR2j/9U9UP"
	...
	<div style="" class="ovenWebview_Nav">
		<a href="/view/msLIKPGTqwMxFjQLhURzl6SrDOJDgR2j/9U9UP"
			...
			href="/view/msLIKPGTqwMxFjQLhURzl6SrDOJDgR2j/dDF35" class="move_next"><span
		...
		<div style="display: none;" class="ovenWebview_MoreMenu">
			...
			<div style="display: none;" class="sub">
				<a href="/view/msLIKPGTqwMxFjQLhURzl6SrDOJDgR2j/JAmP5">1. 로그인 X
					...
					및 다운로드</a><a href="javascript:;" class="current">7. 게시글 작성_홈</a><a
					href="/view/msLIKPGTqwMxFjQLhURzl6SrDOJDgR2j/dDF35">8. 게시글
					작성_글쓰기</a><a href="/view/msLIKPGTqwMxFjQLhURzl6SrDOJDgR2j/Mx3h3">9.
					게시글 작성_게시글</a>
			</div>
