...
<html>
<head>
<title>해빙농도 검색 및 다운로드 (6 of 9)</title>
...
<body data-locale="ko">
	<div id="webView" data-canvas="true" data-show-memo="false"
		...
		<div data-obj-id="dv3Tg" data-obj-type="element"
			...
			style="position: absolute; top: 143px; left: 224px; width: 375px; height: 67px;">
			<div data-text-content="true"
				style="font-weight: bold; font-size: 24px" class="">해빙농도 검색 및
				다운로드</div>
		</div>
		...
		<div data-obj-id="vOV4z" data-obj-type="element"
			data-text-editable="true" class=""
			style="position: absolute; top: 190px; left: 224px; width: 137px; height: 26px;">
			<div data-text-content="true" style="font-size: 16px;" class="">
				<span style="font-size: large;">input="month"</span>
			</div>
		</div>
		<div data-obj-id="NNJho" data-obj-type="element"
			data-text-editable="true" class=""
			style="position: absolute; top: 190px; left: 361px; width: 60px; height: 26px;">
			<div data-text-content="true"
				style="font-size: 12px; color: rgb(255, 255, 255); text-align: center; line-height: 2em; border-top-left-radius: 4px; border-top-right-radius: 4px; border-bottom-right-radius: 4px; border-bottom-left-radius: 4px; background-color: rgb(52, 152, 219);"
				class="">조회</div>
		</div>
		<div data-obj-id="fpbww" data-obj-type="element"
			data-text-editable="true" class=""
			style="position: absolute; top: 190px; left: 432px; width: 60px; height: 26px;">
			<div data-text-content="true"
				style="font-size: 12px; color: rgb(255, 255, 255); text-align: center; line-height: 2em; border-top-left-radius: 4px; border-top-right-radius: 4px; border-bottom-right-radius: 4px; border-bottom-left-radius: 4px; background-color: rgb(52, 152, 219);"
				class="">다운로드</div>
		</div>
		<div data-obj-id="OCtUd" data-obj-type="element" class=""
			style="position: absolute; top: 241px; left: 224px; width: 691px; height: 488px;">
			<div data-image-content="true"
	...
	<div style="" class="ovenWebview_Nav">
		<a href="/view/msLIKPGTqwMxFjQLhURzl6SrDOJDgR2j/oQXnm"
			...
			href="/view/msLIKPGTqwMxFjQLhURzl6SrDOJDgR2j/K8GLD" class="move_next"><span
		...
		<div style="display: none;" class="ovenWebview_MoreMenu">
			...
			<div style="display: none;" class="sub">
				<a href="/view/msLIKPGTqwMxFjQLhURzl6SrDOJDgR2j/JAmP5">1. 로그인 X
					...
					href="javascript:;" class="current">6. 해빙농도 검색 및 다운로드</a><a
					href="/view/msLIKPGTqwMxFjQLhURzl6SrDOJDgR2j/K8GLD">7. 게시글 작성_홈</a><a
